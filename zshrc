...
setopt hist_ignore_space #no guarda en el historial los comandos que empiezan con espacios
#setopt hist_verify 
...
ZSH_HIGHLIGHT_STYLES[unknown]=fg=red,underline #este color sera por defecto si el comando no existe este color no cambiara
